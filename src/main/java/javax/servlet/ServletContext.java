...
public interface ServletContext {
    ...
    /**
     * The name of the <code>ServletContext</code> attribute which stores the private temporary directory (of type
     * <code>java.io.File</code>) provided by the servlet container for the <code>ServletContext</code>
     */
     ...
     * {@link RequestDispatcher} objects from the context. The given path must be begin with <code>/</code>, is interpreted
     ...
     *
     * <p>
     * Paths indicating subdirectory paths end with a <code>/</code>.
     *
     * <p>
     * The returned paths are all relative to the root of the web application, or relative to the
     * <code>/META-INF/resources</code> directory of a JAR file inside the web application's <code>/WEB-INF/lib</code>
     * directory, and have a leading <code>/</code>.
     *
     * <p>
     ...
     * </pre>
     *
     * <code>getResourcePaths("/")</code> would return <code>{"/welcome.html", "/catalog/", "/customer/", "/WEB-INF/"}</code>,
     * and <code>getResourcePaths("/catalog/")</code> would return <code>{"/catalog/index.html", "/catalog/products.html",
     * "/catalog/offers/", "/catalog/moreOffers/"}</code>.
     *
     ...
     *
     * <p>
     * The path must begin with a <code>/</code> and is interpreted as relative to the current context root, or relative to
     * the <code>/META-INF/resources</code> directory of a JAR file inside the web application's <code>/WEB-INF/lib</code>
     * directory. This method will first search the document root of the web application for the requested resource,
     * before searching any of the JAR files inside <code>/WEB-INF/lib</code>. The order in which the JAR files inside
     * <code>/WEB-INF/lib</code> are searched is undefined.
     *
     * <p>
     ...
     *
     * <p>
     * The pathname must begin with a <code>/</code> and is interpreted as relative to the current context root. Use
     ...
     *
     * <p>
     * For example, if <code>path</code> is equal to <code>/index.html</code>, this method will return the absolute file path on
     * the server's filesystem to which a request of the form
     * <code>http://&lt;host&gt;:&lt;port&gt;/&lt;contextPath&gt;/index.html</code> would be mapped, where
     * <code>&lt;contextPath&gt;</code> corresponds to the context path of this ServletContext.
     *
     * <p>
     ...
     *
     * <p>
     * Resources inside the <code>/META-INF/resources</code> directories of JAR files bundled in the application's
     * <code>/WEB-INF/lib</code> directory must be considered only if the container has unpacked them from their containing
     ...
     *
     * @return the <i>real</i> path, or <code>null</code> if the translation cannot be performed
     */
     ...
     *
     * <p>
     * The specified <code>className</code> will be loaded using the classloader associated with the application represented
     ...
     * <code>servletName</code>, it will be completed (by assigning the given <code>className</code> to it) and returned.
     *
     * <p>
     * This method introspects the class with the given <code>className</code> for the
     * {@link javax.servlet.annotation.ServletSecurity}, {@link javax.servlet.annotation.MultipartConfig},
     * <code>javax.annotation.security.RunAs</code>, and <code>javax.annotation.security.DeclareRoles</code> annotations. In
     * addition, this method supports resource injection if the class with the given <code>className</code> represents a
     ...
     *         <code>null</code> if this ServletContext already contains a complete ServletRegistration for a servlet with
    ...
    /**
     * Registers the given servlet instance with this ServletContext under the given <code>servletName</code>.
     *
     * <p>
     * The registered servlet may be further configured via the returned {@link ServletRegistration} object.
     *
     * <p>
     * If this ServletContext already contains a preliminary ServletRegistration for a servlet with the given
     * <code>servletName</code>, it will be completed (by assigning the class name of the given servlet instance to it) and
     * returned.
     *
     * @param servletName the name of the servlet
     * @param servlet     the servlet instance to register
     *
     * @return a ServletRegistration object that may be used to further configure the given servlet, or <code>null</code> if
     *         this ServletContext already contains a complete ServletRegistration for a servlet with the given
     *         <code>servletName</code> or if the same servlet instance has already been registered with this or another
     ...
     * <p>
     * If this ServletContext already contains a preliminary ServletRegistration for a servlet with the given
     * <code>servletName</code>, it will be completed (by assigning the name of the given <code>servletClass</code> to it) and
     * returned.
     *
     * <p>
     * This method introspects the given <code>servletClass</code> for the {@link javax.servlet.annotation.ServletSecurity},
     * {@link javax.servlet.annotation.MultipartConfig}, <code>javax.annotation.security.RunAs</code>, and
     * <code>javax.annotation.security.DeclareRoles</code> annotations. In addition, this method supports resource injection
     * if the given <code>servletClass</code> represents a Managed Bean. See the Jakarta EE platform and CDI specifications
     ...
     *
     * @return a ServletRegistration object that may be used to further configure the registered servlet, or
     *         <code>null</code> if this ServletContext already contains a complete ServletRegistration for the given
     ...
     * <p>
     * If this ServletContext already contains a preliminary ServletRegistration for a servlet with the given
     * <code>servletName</code>, it will be completed (by assigning the given <code>jspFile</code> to it) and returned.
     *
     * @param servletName the name of the servlet
     ...
     *
     * <p>
     * This method introspects the given <code>clazz</code> for the following annotations:
     * {@link javax.servlet.annotation.ServletSecurity}, {@link javax.servlet.annotation.MultipartConfig},
     * <code>javax.annotation.security.RunAs</code>, and <code>javax.annotation.security.DeclareRoles</code>. In addition, this
     * method supports resource injection if the given <code>clazz</code> represents a Managed Bean. See the Jakarta EE
    ...
    /**
     * Gets the ServletRegistration corresponding to the servlet with the given <code>servletName</code>.
     *
     * @param servletName the name of a servlet
     *
     * @return the (complete or preliminary) ServletRegistration for the servlet with the given <code>servletName</code>, or
     ...
     * <code>addServlet</code> and <code>addJspFile</code> methods.
     *
     * <p>
     ...
     * <code>filterName</code>, it will be completed (by assigning the given <code>className</code> to it) and returned.
     *
     * <p>
     * This method supports resource injection if the class with the given <code>className</code> represents a Managed Bean.
     ...
     *
     * @return a FilterRegistration object that may be used to further configure the registered filter, or <code>null</code>
    ...
    /**
     * Registers the given filter instance with this ServletContext under the given <code>filterName</code>.
     *
     * <p>
     * The registered filter may be further configured via the returned {@link FilterRegistration} object.
     *
     * <p>
     * If this ServletContext already contains a preliminary FilterRegistration for a filter with the given
     * <code>filterName</code>, it will be completed (by assigning the class name of the given filter instance to it) and
     * returned.
     *
     * @param filterName the name of the filter
     * @param filter     the filter instance to register
     *
     * @return a FilterRegistration object that may be used to further configure the given filter, or <code>null</code> if
     *         this ServletContext already contains a complete FilterRegistration for a filter with the given
     *         <code>filterName</code> or if the same filter instance has already been registered with this or another
     *         ServletContext in the same container
     *
     * @throws IllegalStateException         if this ServletContext has already been initialized
     *
     ...
     * <p>
     * If this ServletContext already contains a preliminary FilterRegistration for a filter with the given
     * <code>filterName</code>, it will be completed (by assigning the name of the given <code>filterClass</code> to it) and
     * returned.
     *
     * <p>
     * This method supports resource injection if the given <code>filterClass</code> represents a Managed Bean. See the Java
    ...
    /**
     * Gets the FilterRegistration corresponding to the filter with the given <code>filterName</code>.
     *
     * @param filterName the name of a filter
     * @return the (complete or preliminary) FilterRegistration for the filter with the given <code>filterName</code>, or
     ...
     * created on behalf of this <code>ServletContext</code> may be configured.
     *
     * <p>
     * Repeated invocations of this method will return the same <code>SessionCookieConfig</code> instance.
     *
     * @return the <code>SessionCookieConfig</code> object through which various properties of the session tracking cookies
     *         created on behalf of this <code>ServletContext</code> may be configured
     *
     * @throws UnsupportedOperationException if this ServletContext was passed to the
     *                                       {@link ServletContextListener#contextInitialized} method of a
    ...
    /**
     * Sets the session tracking modes that are to become effective for this <code>ServletContext</code>.
     *
     * <p>
     * The given <code>sessionTrackingModes</code> replaces any session tracking modes set by a previous invocation of this
     * method on this <code>ServletContext</code>.
     *
     ...
     *                                       {@link javax.servlet.annotation.WebListener}
     *
     * @throws IllegalArgumentException      if <code>sessionTrackingModes</code> specifies a combination of
     *                                       <code>SessionTrackingMode.SSL</code> with a session tracking mode other than
     *                                       <code>SessionTrackingMode.SSL</code>, or if <code>sessionTrackingModes</code>
    ...
    /**
     * Gets the session tracking modes that are supported by default for this <code>ServletContext</code>.
     *
     * <p>
     * The returned set is not backed by the {@code ServletContext} object, so changes in the returned set are not
     * reflected in the {@code ServletContext} object, and vice-versa.
     * </p>
     *
     * @return set of the session tracking modes supported by default for this <code>ServletContext</code>
     *
     * @throws UnsupportedOperationException if this ServletContext was passed to the
     *                                       {@link ServletContextListener#contextInitialized} method of a
     *                                       {@link ServletContextListener} that was neither declared in
    ...
    /**
     * Gets the session tracking modes that are in effect for this <code>ServletContext</code>.
     *
     * <p>
     ...
     * </p>
     *
     * @return set of the session tracking modes in effect for this <code>ServletContext</code>
     *
     * @throws UnsupportedOperationException if this ServletContext was passed to the
     *                                       {@link ServletContextListener#contextInitialized} method of a
     *                                       {@link ServletContextListener} that was neither declared in
     ...
     *
     * <p>
     * The given <code>listenerClass</code> must implement one or more of the following interfaces:
     * <ul>
     * <li>{@link ServletContextAttributeListener}
     * <li>{@link ServletRequestListener}
     * <li>{@link ServletRequestAttributeListener}
     ...
     * <code>listenerClass</code> may also implement {@link ServletContextListener}, in addition to the interfaces listed
     * above.
     *
     * <p>
     * If the given <code>listenerClass</code> implements a listener interface whose invocation order corresponds to the
     * declaration order (i.e., if it implements {@link ServletRequestListener}, {@link ServletContextListener}, or
     * {@link javax.servlet.http.HttpSessionListener}), then the new listener will be added to the end of the ordered
     * list of listeners of that interface.
     *
     * <p>
     * This method supports resource injection if the given <code>listenerClass</code> represents a Managed Bean. See the
     ...
     *
     * @throws IllegalArgumentException      if the given <code>listenerClass</code> does not implement any of the above
     *                                       interfaces, or if it implements {@link ServletContextListener} and this
     *                                       ServletContext was not passed to
     *                                       {@link ServletContainerInitializer#onStartup}
     *
    ...
    /**
     * Gets the session timeout in minutes that are supported by default for this <code>ServletContext</code>.
     *
     * @return the session timeout in minutes that are supported by default for this <code>ServletContext</code>
     *
     * @throws UnsupportedOperationException if this ServletContext was passed to the
     *                                       {@link ServletContextListener#contextInitialized} method of a
     *                                       {@link ServletContextListener} that was neither declared in
    ...
    /**
     * Gets the request character encoding that are supported by default for this <code>ServletContext</code>. This method
     ...
     *
     * @return the request character encoding that are supported by default for this <code>ServletContext</code>
     *
     * @throws UnsupportedOperationException if this ServletContext was passed to the
     *                                       {@link ServletContextListener#contextInitialized} method of a
     *                                       {@link ServletContextListener} that was neither declared in
    ...
    /**
     * Gets the response character encoding that are supported by default for this <code>ServletContext</code>. This method
