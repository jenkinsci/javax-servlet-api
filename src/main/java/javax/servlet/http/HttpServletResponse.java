...
public interface HttpServletResponse extends ServletResponse {
     ...
     *
     * @return the value of the response header with the given name, or <code>null</code> if no header with the given name
    ...
    default jakarta.servlet.http.HttpServletResponse toJakartaHttpServletResponse() {
        return new jakarta.servlet.http.HttpServletResponse() {
            ...
            public jakarta.servlet.ServletOutputStream getOutputStream() throws IOException {
                return HttpServletResponse.this.getOutputStream().toJakartaServletOutputStream();
            }
            ...
            public void setCharacterEncoding(String charset) {
                HttpServletResponse.this.setCharacterEncoding(charset);
            }

            @Override
            public void setContentLength(int len) {
                HttpServletResponse.this.setContentLength(len);
            }

            @Override
            public void setContentLengthLong(long len) {
                HttpServletResponse.this.setContentLengthLong(len);
            }

            @Override
            public void setContentType(String type) {
                HttpServletResponse.this.setContentType(type);
            }

            @Override
            public void setBufferSize(int size) {
                HttpServletResponse.this.setBufferSize(size);
            }
            ...
            public void setLocale(Locale loc) {
                HttpServletResponse.this.setLocale(loc);
            }
            ...
            public boolean containsHeader(String name) {
                return HttpServletResponse.this.containsHeader(name);
            }

            @Override
            public String encodeURL(String url) {
                return HttpServletResponse.this.encodeURL(url);
            }

            @Override
            public String encodeRedirectURL(String url) {
                return HttpServletResponse.this.encodeRedirectURL(url);
            }
            ...
            public void sendError(int sc, String msg) throws IOException {
                HttpServletResponse.this.sendError(sc, msg);
            }

            @Override
            public void sendError(int sc) throws IOException {
                HttpServletResponse.this.sendError(sc);
            }

            @Override
            public void sendRedirect(String location) throws IOException {
                HttpServletResponse.this.sendRedirect(location);
            }

            @Override
            public void setDateHeader(String name, long date) {
                HttpServletResponse.this.setDateHeader(name, date);
            }

            @Override
            public void addDateHeader(String name, long date) {
                HttpServletResponse.this.addDateHeader(name, date);
            }

            @Override
            public void setHeader(String name, String value) {
                HttpServletResponse.this.setHeader(name, value);
            }

            @Override
            public void addHeader(String name, String value) {
                HttpServletResponse.this.addHeader(name, value);
            }

            @Override
            public void setIntHeader(String name, int value) {
                HttpServletResponse.this.setIntHeader(name, value);
            }

            @Override
            public void addIntHeader(String name, int value) {
                HttpServletResponse.this.addIntHeader(name, value);
            }

            @Override
            public void setStatus(int sc) {
                HttpServletResponse.this.setStatus(sc);
            }

            @Override
            public void setStatus(int sc, String sm) {
                HttpServletResponse.this.setStatus(sc, sm);
            }
            ...
            public String getHeader(String name) {
                return HttpServletResponse.this.getHeader(name);
            }

            @Override
            public Collection<String> getHeaders(String name) {
                return HttpServletResponse.this.getHeaders(name);
            }
    ...
    static HttpServletResponse fromJakartaHttpServletResponse(jakarta.servlet.http.HttpServletResponse from) {
