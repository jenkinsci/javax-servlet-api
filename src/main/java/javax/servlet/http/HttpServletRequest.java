...
public interface HttpServletRequest extends ServletRequest {
    ...
    default jakarta.servlet.http.HttpServletRequest toJakartaHttpServletRequest() {
        return new jakarta.servlet.http.HttpServletRequest() {
            ...
            public Object getAttribute(String name) {
                return HttpServletRequest.this.getAttribute(name);
            }
            ...
            public void setCharacterEncoding(String env) throws UnsupportedEncodingException {
                HttpServletRequest.this.setCharacterEncoding(env);
            }
            ...
            public jakarta.servlet.ServletInputStream getInputStream() throws IOException {
                return HttpServletRequest.this.getInputStream().toJakartaServletInputStream();
            }

            @Override
            public String getParameter(String name) {
                return HttpServletRequest.this.getParameter(name);
            }
            ...
            public String[] getParameterValues(String name) {
                return HttpServletRequest.this.getParameterValues(name);
            }
            ...
            public void setAttribute(String name, Object o) {
                HttpServletRequest.this.setAttribute(name, o);
            }

            @Override
            public void removeAttribute(String name) {
                HttpServletRequest.this.removeAttribute(name);
            }
            ...
            public jakarta.servlet.RequestDispatcher getRequestDispatcher(String path) {
                return HttpServletRequest.this.getRequestDispatcher(path).toJakartaRequestDispatcher();
            }

            @Override
            public String getRealPath(String path) {
                return HttpServletRequest.this.getRealPath(path);
            }
            ...
            public jakarta.servlet.AsyncContext startAsync() {
                return HttpServletRequest.this.startAsync().toJakartaAsyncContext();
            }
            ...
            public jakarta.servlet.AsyncContext getAsyncContext() {
                return HttpServletRequest.this.getAsyncContext().toJakartaAsyncContext();
            }

            @Override
            public jakarta.servlet.DispatcherType getDispatcherType() {
                return DispatcherType.toJakartaDispatcherType(HttpServletRequest.this.getDispatcherType());
            }
            ...
            public jakarta.servlet.http.Cookie[] getCookies() {
                return Stream.of(HttpServletRequest.this.getCookies())
            ...
            public long getDateHeader(String name) {
                return HttpServletRequest.this.getDateHeader(name);
            }

            @Override
            public String getHeader(String name) {
                return HttpServletRequest.this.getHeader(name);
            }

            @Override
            public Enumeration<String> getHeaders(String name) {
                return HttpServletRequest.this.getHeaders(name);
            }
            ...
            public int getIntHeader(String name) {
                return HttpServletRequest.this.getIntHeader(name);
            }
            ...
            public boolean isUserInRole(String role) {
                return HttpServletRequest.this.isUserInRole(role);
            }
            ...
            public jakarta.servlet.http.HttpSession getSession(boolean create) {
                HttpSession session = HttpServletRequest.this.getSession(create);
                return session != null ? session.toJakartaHttpSession() : null;
            }

            @Override
            public jakarta.servlet.http.HttpSession getSession() {
                HttpSession session = HttpServletRequest.this.getSession();
                return session != null ? session.toJakartaHttpSession() : null;
            }
            ...
            public void login(String username, String password) throws jakarta.servlet.ServletException {
                try {
                    HttpServletRequest.this.login(username, password);
                } catch (ServletException e) {
                    throw e.toJakartaServletException();
                }
            }
            ...
            public Collection<jakarta.servlet.http.Part> getParts()
                    throws IOException, jakarta.servlet.ServletException {
                try {
                    return HttpServletRequest.this.getParts().stream()
            ...
            public jakarta.servlet.http.Part getPart(String name) throws IOException, jakarta.servlet.ServletException {
                try {
                    return HttpServletRequest.this.getPart(name).toJakartaPart();
                } catch (ServletException e) {
                    throw e.toJakartaServletException();
                }
            }
    ...
    static HttpServletRequest fromJakartaHttpServletRequest(jakarta.servlet.http.HttpServletRequest from) {
