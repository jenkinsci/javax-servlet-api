...
public interface ServletRequest {
     ...
     *
     * <p>
     * This method returns <code>false</code> if this request was put into asynchronous mode, but has since been dispatched
    ...
    default jakarta.servlet.ServletRequest toJakartaServletRequest() {
        return new jakarta.servlet.ServletRequest() {
            ...
            public jakarta.servlet.ServletInputStream getInputStream() throws IOException {
                return ServletRequest.this.getInputStream().toJakartaServletInputStream();
            }
            ...
            public jakarta.servlet.RequestDispatcher getRequestDispatcher(String path) {
                return ServletRequest.this.getRequestDispatcher(path).toJakartaRequestDispatcher();
            }
            ...
            public jakarta.servlet.AsyncContext startAsync() {
                return ServletRequest.this.startAsync().toJakartaAsyncContext();
            }
            ...
            public jakarta.servlet.AsyncContext getAsyncContext() {
                return ServletRequest.this.getAsyncContext().toJakartaAsyncContext();
            }

            @Override
            public jakarta.servlet.DispatcherType getDispatcherType() {
                return DispatcherType.toJakartaDispatcherType(ServletRequest.this.getDispatcherType());
            }
        };
    }
